...
def get_dishes():
	with open(os.path.join(my_path,'testset.json')) as json_file:
...
def get_cuisine_multipliers(tags):
	with open(os.path.join(my_path,'cuisine_multipliers.json')) as json_file:
...
def get_cuisine_tags(food):
	with open(os.path.join(my_path,'first_50_tags.json')) as json_file:
