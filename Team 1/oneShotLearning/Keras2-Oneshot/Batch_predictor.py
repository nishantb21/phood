...
def predict(PredPath):
    img_shape = (128,128,1)
    CatPath = os.path.abspath('../Dataset/Food Images/Train')
    ...
    with open(os.path.abspath('predictions/predictions.json'),'w') as outfile:
        json.dump(predDict,outfile)
predict(os.path.abspath('../Dataset/Food Images/Test'))
